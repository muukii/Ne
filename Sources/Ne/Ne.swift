...
extension UIColor {
  ...
  private static func makeColorWithUserInterfaceStyle(makeLight: @escaping () -> UIColor, makeDark: @escaping () -> UIColor) -> UIColor {
  ...
  public static func neon(_ name: NeonColorName, _ adjustment: NeonColorAdjustment = .normal) -> UIColor {
    ...
    case .yellow:
      switch adjustment {
      case .brighter:
        return makeColorWithUserInterfaceStyle(makeLight: {
